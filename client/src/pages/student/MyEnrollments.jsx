...
const MyEnrollments = () => {
  ...
  return (
    <>
    <div className='md:px-35 px-8 pt-10 bg-gradient-to-b from-cyan-100/70'>
          ...
          {enrolledCourses.map((course, index)=>(
            <tr key={index} className='border border-gray-500/20'>
              ...
              <td className='px-4 py-3 max-sm:text-right'>
                <button className='px-3 sm:px-5 py-1.5 sm:py-2 bg-blue-600 max-sm:text-xs text-white rounded-md cursor-pointer' onClick={()=>navigate('/player/' + course._id)}>
