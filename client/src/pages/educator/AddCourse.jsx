  ...
  return (
    <div className="h-screen overflow-scroll flex flex-col items-start justify-between md:p-8 md:pb-0 p-4 pt-8 pb-0">
      <form onSubmit={handleSubmit} className="flex flex-col gap-4 max-w-md w-full text-gray-500">
        ...
        <div className="flex items-center justify-between flex-wrap">
          ...
          <div className="flex md:flex-row flex-col items-center gap-3">
            ...
            <label htmlFor="thumbnailImage" className="flex items-center gap-3">
              ...
              <input type="file" id="thumbnailImage" onChange={e => setImage(e.target.value[0])} accept="image/*" hidden/>
        ...
        <div className="flex flex-col gap-1">
          <p>Discount %</p>
          <input onChange={e => setDiscount(e.target.value)} value={discount} type="number" placeholder="0" min={0} className="outline-none md:py-2.5 py-2 w-28 px-3 rounded border border-gray-500" required/>
        </div>
        {/* Adding chapters and lecturers */}
        <div>
            ...
            <div key={chapterIndex} className="bg-white border rounded-lg mb-4">
              ...
              {!chapter.collapsed && (
                <div className="p-4">
                  ...
                  <div className="inline-flex bg-gray-100 p-2 rounded cursor-pointer mt-2 border" onClick={()=> handleLecture('add', chapter.chapterId)}>+ Add Lecture</div>
                </div>
              )}
            </div>
          ))}
